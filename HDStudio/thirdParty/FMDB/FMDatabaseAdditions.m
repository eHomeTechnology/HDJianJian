...
- (NSString*)applicationIDString {
    NSString *s = (NSString *)NSFileTypeForHFSTypeCode([self applicationID]);
...
- (void)setApplicationIDString:(NSString*)s {
    ...
    if ([s length] != 4) {
        NSLog(@"setApplicationIDString: string passed is not exactly 4 chars long. (was %d)", (int)[s length]);
    }
